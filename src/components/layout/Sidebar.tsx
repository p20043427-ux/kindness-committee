    ...
    >
      ...
      <div className="flex items-center gap-3 px-5 py-4 shrink-0"
        ...
        <div className="min-w-0">
          ...
          <div className="text-[10px] font-medium tracking-widest uppercase" style={{ color: "#7090B0" }}>친절위원회</div>
        </div>
      </div>
              ...
              return (
                <NavLink
                  ...
                  style={({ isActive }) => isActive
                    ? { backgroundColor: "#1558A0", color: "#FFFFFF" }
                    : { color: "#7090B0" }
                  }
                  onMouseEnter={e => {
                    const el = e.currentTarget;
                    if (!el.classList.contains("text-white")) {
                      el.style.backgroundColor = "#102035";
                  ...
                  {({ isActive }) => (
                    <>
                      <Icon
                        ...
                        style={{ color: isActive ? "#93C5FD" : "inherit" }}
                        aria-hidden="true"
                      />
      ...
      {/* Footer */}
      <div className="px-4 py-3 text-[10px] shrink-0" style={{ borderTop: "1px solid #182D44", color: "#2E4A62" }}>
